class StudentFinalMark < ActiveRecord::Base
  attr_accessible :attendance_award, :progress_award, :talent_award, :excellence_award, :school_class_id, :school_year_id, :spirit_award, :student_id, :top_three, :total_score
